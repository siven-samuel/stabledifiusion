...
const saveProject = () => {
  ...
  try {
    ...
    const projectData = {
      ...
      advisorSpriteUrl: props.advisorSpriteUrl || (BASE_URL + 'templates/all/advisor3.png'),
...
const handleFileUpload = async (event) => {
  ...
  try {
    ...
    emit('load-project', {
      ...
      advisorSpriteUrl: projectData.advisorSpriteUrl || (BASE_URL + 'templates/all/advisor3.png'),
